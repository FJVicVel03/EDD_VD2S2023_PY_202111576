...
import (
	"EDD_VD2S2023_PYF2_202111576/estructuras/Peticiones"
	"EDD_VD2S2023_PYF2_202111576/estructuras/arbolB"
	"EDD_VD2S2023_PYF2_202111576/estructuras/arbolMerkle"
	"EDD_VD2S2023_PYF2_202111576/estructuras/grafo"
	"EDD_VD2S2023_PYF2_202111576/estructuras/tablaHash"
	"crypto/sha256"
	"encoding/base64"
	"encoding/hex"
	"fmt"
...
func Validar(c *fiber.Ctx) error {
	...
	if usuario.UserName == "ADMIN_202111576" {
...
func RegistrarTutor(c *fiber.Ctx) error {
	...
	arbolTutor.Graficar("ArbolitoTutor")
	return c.JSON(&fiber.Map{
		"status": 200,
	})
}
...
func RegistrarCursos(c *fiber.Ctx) error {
	...
	grafoCursos.Reporte("GrafoCursos")
	return c.JSON(&fiber.Map{
		"status": 200,
	})
}
