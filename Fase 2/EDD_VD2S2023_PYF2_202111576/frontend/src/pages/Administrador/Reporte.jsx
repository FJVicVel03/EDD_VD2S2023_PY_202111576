...
function Reporte() {
  const [imagen, setImagen] = useState(
    "https://hips.hearstapps.com/es.h-cdn.co/fotoes/images/noticias/videojuegos/halo-4-necesita-disco-duro-para-el-multijugador/5664781-1-esl-ES/Halo-4-necesita-disco-duro-para-el-multijugador.jpg"
  );
  const salir = (e) => {
    e.preventDefault();
    console.log("Listo");
    ...
    <div className="form-signin1">
      <div className="text-center">
        <form className="card card-body">
          ...
          <br />
          <p className="mt-5 mb-3 text-muted">EDD 202111576</p>
          <br />
        </form>
      </div>
    </div>
