...
import (
	"Proyecto1_202111576/estructuras/GenerarArchivo"
	"fmt"
	"strconv"
)
...
func (m *Matriz) Reporte(nombre string) {
	texto := ""
	nombre_archivo := "./Asignaciones.dot"
	...
	//fmt.Println(texto)
	GenerarArchivo.CrearArchivo(nombre_archivo)
	GenerarArchivo.EscribirArchivo(texto, nombre_archivo)
	GenerarArchivo.Ejecutar(nombre_imagen, nombre_archivo)
}
